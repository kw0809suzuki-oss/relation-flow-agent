#!/usr/bin/env python3
"""Independent fresh10 replication for frozen Payback Closure Candidate v0."""
import json
import os
...
CASES = [(5501+i, i%2) for i in range(10)]
OUT = Path("payback_closure_candidate_fresh10_rep2_v0.json")
...
def main():
    ...
    result = {
        "schema": "kaggriculture.payback-closure-candidate.fresh10.rep2.v0",
        "objective": "independent replication of frozen 14-day closure gate",
        "candidate": "remaining_horizon <= 14 => suppress new expansion purchases",
        "candidate_source": "payback_closure_candidate_v0.py unchanged",
        "cases": rows,
        "summary": summary,
    }
    OUT.write_text(json.dumps(result, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print("PAYBACK_CLOSURE_FRESH10_REP2_SUMMARY " + json.dumps(summary, separators=(",", ":")))
    print("PAYBACK_CLOSURE_FRESH10_REP2_ROWS " + json.dumps(rows, separators=(",", ":")))
