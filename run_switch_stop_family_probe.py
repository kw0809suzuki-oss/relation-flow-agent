...
import whole_flow_control_agent_v2_switch_stop_probe as probe
...
def main():
    ...
    result = {
        "schema": "kaggriculture.candidate-family-probe.switch-stop.v0",
        "family": {
            "combat": "switch",
            "economic": "stop",
    ...
    Path("switch_stop_family_probe_result.json").write_text(
