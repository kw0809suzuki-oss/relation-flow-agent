...
import whole_flow_control_agent_v2_maintain_stop_probe as probe
...
def main():
    ...
    result = {
        "schema": "kaggriculture.candidate-family-probe.maintain-stop.v0",
        "family": {
            "combat": "maintain",
            "economic": "stop",
    ...
    Path("maintain_stop_family_probe_result.json").write_text(
